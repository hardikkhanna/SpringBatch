/*
 * package com.sprindemo.batch.controller;
 * 
 ...
 * 
 * @RestController public class JobInvokerController {
 * 
 * @Autowired JobLauncher jobLauncher;
 * 
 * @Autowired Job processJob;
 * 
 * @RequestMapping("/invokejob") public String handle() throws Exception {
 * 
 * JobParameters jobParameters = new JobParametersBuilder().addLong("time",
 * System.currentTimeMillis()) .toJobParameters(); jobLauncher.run(processJob,
 * jobParameters);
 * 
